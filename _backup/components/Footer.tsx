  ...
  return (
    <footer className="bg-slate-950 text-slate-400 py-12 border-t border-slate-800">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          <Link href="/" className="inline-block mb-6 bg-white/10 p-4 rounded-xl">
            <Image src="/jbz-new-logo-nobg.png" alt="JBZ Construction Logo" width={400} height={150} className="w-auto h-16 md:h-20 object-contain" />
          </Link>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li><Link href="/services/siding" className="hover:text-white transition">Siding Installation & Repair</Link></li>
            <li><Link href="/services/carpentry" className="hover:text-white transition">Custom Exterior Carpentry</Link></li>
            <li><Link href="/services/windows" className="hover:text-white transition">Energy Efficient Windows</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p className="text-sm font-bold text-white mb-2">
            <a href="tel:919-555-0198" className="hover:text-white transition">(919) 555-0198</a>
          </p>
          <p className="text-sm mb-4">contact@jbzconstruction.com</p>
